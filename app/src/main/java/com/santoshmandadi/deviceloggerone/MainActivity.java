...
public class MainActivity extends AppCompatActivity
    ...
    private String SCANFRAGMENT_TAG = "SCTAG";
...
//        }
            ...
            case IntentIntegrator.REQUEST_CODE:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (result != null) {
                        ...
                        if (result.getContents().contains(ScanFragment.DEVICE_NAME_TAG))
                            arguments.putString(ScanFragment.SCANNED_DEVICE, result.getContents());
                        else if (result.getContents().contains(ScanFragment.USER_NAME_TAG))
                            arguments.putString(ScanFragment.SCANNED_USER, result.getContents());


                        ScanFragment fragment = new ScanFragment();
                        fragment.setArguments(arguments);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.content_frame, fragment, SCANFRAGMENT_TAG)
    ...
    public void showErrorSnackBar(View view, String s) {
